...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.nenggala.build.version";
    public static final String PROP_BUILD_VERSION_INCREMENTAL = "ro.build.version.incremental";
    public static final String PROP_DEVICE = "ro.nenggala.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.nenggala.releasetype";
